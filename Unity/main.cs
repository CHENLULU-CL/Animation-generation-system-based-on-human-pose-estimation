...
public class main : MonoBehaviour
{
    ...
    {
        // 读取关键点数据
        StreamReader sr = new StreamReader(@"F:\UnityWorks\ThreeDExperiment-master\ThreeDExperiment-master\Assets\Resources\record.txt", System.Text.Encoding.Default);
        string line;
